...
/*----------------------------------------*/
@import url("https://fonts.googleapis.com/css2?family=Jost:wght@300;400;500;600;700display=swap");
...
:root {
  ...
  */
    ...
    --tp-grey-9: #999999;
    --tp-text-body: #040404;
    --tp-text-primary: #0c3256;
    --tp-text-danger: #b94c4c;
...
/* Hide scrollbar - Chrome, Safari, Edge (Webkit-based) */
...
.tpproduct-details__out_stock {
    font-size: 12px;
    font-weight: 600;
    color: var(--tp-text-danger);
    border: 1px solid var(--tp-border-1);
    border-radius: 2px;
    padding: 4px 9px;
    line-height: 1;
...
.your-order-table table .heading {
    border-top: medium none;
    color: #6f7172;
    font-weight: normal;
    text-align: left;
...
/* Set minimum width and handle long text in dropdown */
.category-menu,
.cat-menu__list,
.cat-menu__list .submenu {
    min-width: 220px;
    white-space: normal;
...
/* Optional: Give submenu a max width if content is too long */
.cat-menu__list .submenu {
    max-width: 300px;
    padding: 10px 15px;
}
...
.orders-payment.paid { color: #28a745; font-weight: 500; }
.orders-payment.cod  { color: #fd7e14; font-weight: 500; }
.orders-status.pending   { color: #ffc107; font-weight: 500; }
.orders-status.delivered { color: #28a745; font-weight: 500; }
.orders-status.cancelled { color: #dc3545; font-weight: 500; }
